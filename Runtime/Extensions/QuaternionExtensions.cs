namespace KoheiUtils
{
    ...
    public static class QuaternionExtensions
    {
        ...
        public static Quaternion Wobble(this Quaternion q, float wobbleDegree)
        {
            float degreeX = MyRandom.NextGaussian() * wobbleDegree;
            float degreeY = MyRandom.NextGaussian() * wobbleDegree;
