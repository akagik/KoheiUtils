namespace KoheiUtils
{
    ...
    public class EditorCoroutineRunner
    {
        ...
        public static EditorCoroutine StartCoroutineWithUI(IEnumerator coroutine, string title,
    ...
    internal class EditorCoroutineState
    {
        ...
        private EditorCoroutine
            nestedCoroutine; // for tracking nested coroutines that are not started with EditorCoroutineRunner.StartCoroutine
